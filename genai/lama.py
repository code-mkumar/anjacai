...
def query_lm_studio(prompt, context):
    ...
    prompt_role = 'student counsellor' if role == 'student' else 'staff assistant' if role == 'staff' else 'AI assistant'
    ...
    try:
        ...
        if context == "AYYA NADAR JANAKI AMMAL COLLEGE' college loaction:'srivilliputur road ,sivakasi'":                  
